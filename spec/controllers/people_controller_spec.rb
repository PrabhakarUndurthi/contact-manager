...
describe PeopleController do
  ...
  let(:valid_attributes) { { first_name: 'prabhakar' , last_name: 'undurthi'} }
  ...
  describe "GET show page" do
    it "it assigns the requested person as @person" do
      person = Person.create! valid_attributes
  ...
  describe "GET the new page" do
    it "it assigns the new person as @person" do
  ...
  describe "POST create " do
    describe "with valid params" do
      ...
      expect { post :create, { :person => valid_attributes}, valid_session}.to change(Person, :count).by(1)
      end
      it "assigns the newly create person as @person" do
        post :create, {:person => valid_attributes}, valid_session
        assigns(:person).should be_a(Person)
        assigns(:person).should be_persisted
      end
      it "redirects to the newly created @person" do
        post :create, {:person =>  valid_attributes}, valid_session
        response.should  redirect_to(Person.last)
      end
      describe "with invalid params" do
        it "assigns the newly created but unsaved person as @person" do
